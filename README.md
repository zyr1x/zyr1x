...
### 🔥 About Me
- 🛠 **Разработка**: Backend, Fullstack, Android, Minecraft (Bukkit API / Forge / Fabric)
- 🐧 **Любимая ОС**: Linux (Fedora)
- 🎯 **Интересы**: DI-фреймворки, распределённые системы, JVM-экосистема
...
[![VK](https://img.shields.io/badge/VK-%230077FF?style=for-the-badge&logo=vk&logoColor=white)](https://vk.com/i3w1s)
